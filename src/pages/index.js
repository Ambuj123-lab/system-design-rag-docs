        ...
        <section className="ts-hero">
          <div className="ts-hero__content">
            ...
            <h2 className="ts-hero__subtitle">
              Production RAG.<br />Engineered for reality.
            </h2>
        ...
        <section className="ts-grid">
          ...
          <div className="ts-grid__right">
            ...
            <div className="ts-logos">
              <a href="https://github.com/Ambuj123-lab" target="_blank" rel="noreferrer" className="ts-logo-link">
              ...
              <a href="https://www.linkedin.com/in/ambuj-tripathi-042b4a118/" target="_blank" rel="noreferrer" className="ts-logo-link">
              ...
              <a href="https://ambuj-portfolio-v2.netlify.app" target="_blank" rel="noreferrer" className="ts-logo-link">
